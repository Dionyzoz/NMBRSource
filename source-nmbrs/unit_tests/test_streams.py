...
import pytest
from source_nmbrs.source import NmbrsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(NmbrsStream, "path", "v0/example_endpoint")
    mocker.patch.object(NmbrsStream, "primary_key", "test_primary_key")
    mocker.patch.object(NmbrsStream, "__abstractmethods__", set())
